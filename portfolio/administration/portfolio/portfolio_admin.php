...
<body>
    ...
    <div id="main" class="wrapper style1">
        <div class="container">
            <header class="major">
                <h2>Accroche de la page Portfolio</h2>
            </header>    
                        ...
                        echo '<table class="alt">';
                            echo "<thead>";
                                echo "<tr>";
                                    ...
                                    echo "<th>Image de mise en avant</th>";
                                echo "</tr>";
                            echo "</thead>";
                            echo "<tbody>";
                            foreach($result as $row){
                                echo "<tr>";
                                    ...
                                    echo "<td>";
                                        echo '<a href="read.php?id='. $row['id'] .'" class="me-3" ><span class="bi bi-eye"></span></a>';
                                        echo '<a href="modif_projets.php?id='. $row['id'] .'" class="me-3" ><span class="bi bi-pencil"></span></a>';
                                        echo '<a href="suppr_projets.php?id='. $row['id'] .'" ><span class="bi bi-trash"></span></a>';
                                    echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";                            
